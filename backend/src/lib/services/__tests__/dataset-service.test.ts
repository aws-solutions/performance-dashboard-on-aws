...
const widgetRepo = mocked(WidgetRepository.prototype);
const datasetRepo = mocked(DatasetRepository.prototype);
...
describe("updateDataset", () => {
    ...
    test("should update the dataset in dynamodb and S3", async () => {
        ...
        expect(datasetRepo.updateDataset).toBeCalledWith("001", newMetadata, newDatasetContent);
    });
