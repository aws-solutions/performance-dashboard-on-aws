...
describe("handleItemEvent", () => {
    it("discards event if item is not a Dashboard", async () => {
        ...
        await AuditTrailService.handleItemEvent(ItemEvent.Create, oldItem, newItem, timestamp);
    ...
    it("creates an audit log for a dashboard update event", async () => {
        ...
        await AuditTrailService.handleItemEvent(ItemEvent.Update, oldItem, newItem, timestamp);
    ...
    it("creates an audit log for a dashboard delete event", async () => {
        ...
        await AuditTrailService.handleItemEvent(ItemEvent.Delete, oldItem, newItem, timestamp);
