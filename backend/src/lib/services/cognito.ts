...
class CognitoService {
    ...
    async updateUserAttributes(
        ...
        return await this.cognitoIdentityServiceProvider.adminUpdateUserAttributes(input).promise();
    }
}
