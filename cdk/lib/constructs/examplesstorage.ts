...
interface Props {
  examplesBucketName: string;
}

export class ExamplesStorage extends cdk.Construct {
  public readonly contentBucket: s3.Bucket;

  constructor(scope: cdk.Construct, id: string, props: Props) {
    super(scope, id);

    this.contentBucket = new s3.Bucket(scope, "ExampleBucket", {
       ...
       */
      bucketName: props.examplesBucketName,
      /**
