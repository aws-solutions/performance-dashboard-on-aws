...
describe("createDraftFromDashboard", () => {
    ...
    it("should create a dashboard with same parentDashboardId", () => {
        const draft = factory.createDraftFromDashboard(dashboard, user, nextVersion);
    ...
    it("should remove the friendlyURL", () => {
        ...
        const draft = factory.createDraftFromDashboard(dashboardWithFriendlyURL, user, nextVersion);
