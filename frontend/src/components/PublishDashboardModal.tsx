...
function PublishDashboardModal(props: PathParams) {
    ...
    const validationSchema = Yup.object().shape({
        releaseNotes: Yup.string().required(t("PublishDashboardModal.MissingVersionNotesError")),
        ...
        acknowledge: Yup.bool().oneOf([true], t("PublishDashboardModal.AcknowledgementRequired")),
    });
    ...
    const publishingGuidanceWithVersionOverride = `${
        settings.publishingGuidance.endsWith(".")
            ...
            : settings.publishingGuidance + "."
    }${hasPublishedVersion() ? " " + t("PublishDashboardModal.OverwriteWarning") : ""}`;
