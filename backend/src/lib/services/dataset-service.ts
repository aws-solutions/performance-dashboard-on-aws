...
function parse(dataset: any, schema: DatasetSchema = DatasetSchema.None): DatasetContent {
...
async function updateDataset(datasetId: string, newMetadata: any, newContent: DatasetContent) {
