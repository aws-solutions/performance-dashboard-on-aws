...
function UserStatus() {
    ...
    return (
        <>
            ...
            <h2 className="margin-top-4 margin-bottom-1">{t("UserStatuses.Unconfirmed")}</h2>
            <div className="usa-prose">
                <p>{t("UserStatuses.UnconfirmedDesc")}</p>
            </div>

            <h2 className="margin-top-4 margin-bottom-1">{t("UserStatuses.Confirmed")}</h2>
            <div className="usa-prose">
                <p>{t("UserStatuses.ConfirmedDesc")}</p>
            </div>

            <h2 className="margin-top-4 margin-bottom-1">{t("UserStatuses.Archived")}</h2>
            <div className="usa-prose">
                <p>{t("UserStatuses.ArchivedDesc")}</p>
            </div>

            <h2 className="margin-top-4 margin-bottom-1">{t("UserStatuses.Compromised")}</h2>
            <div className="usa-prose">
                <p>{t("UserStatuses.CompromisedDesc")}</p>
            </div>

            <h2 className="margin-top-4 margin-bottom-1">{t("UserStatuses.Unknown")}</h2>
            <div className="usa-prose">
                <p>{t("UserStatuses.UnknownDesc")}</p>
            </div>

            <h2 className="margin-top-4 margin-bottom-1">{t("UserStatuses.Reset_Required")}</h2>
            <div className="usa-prose">
