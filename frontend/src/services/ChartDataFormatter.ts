...
function portionChart(parts: Array<string>, exlcudeValues: Array<string>, data?: Array<object>){
    ...
    for (let i = 0, dataLength = data.length, item = null; i < dataLength && (item = data[i]); i++) {
...
function pieChart(parts: Array<string>, exlcudeValues: Array<string>, data?: Array<object>){
    return portionChart(parts, exlcudeValues, data);
}
function donutChart(parts: Array<string>, exlcudeValues: Array<string>, data?: Array<object>){
    return portionChart(parts, exlcudeValues, data);
}
