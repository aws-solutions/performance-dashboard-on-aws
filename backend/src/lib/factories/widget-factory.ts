        ...
        content: {
            ...
            computePercentages:
                chartWidget.content.computePercentages !== undefined
                    ...
                    : false,
            showTotal:
                chartWidget.content.showTotal !== undefined ? chartWidget.content.showTotal : true,
        },
    };
}
        ...
        content: {
            ...
            significantDigitLabels:
                widget.content.significantDigitLabels !== undefined
                    ...
                    : false,
            dataLabels: widget.content.dataLabels !== undefined ? widget.content.dataLabels : false,
            computePercentages:
                widget.content.computePercentages !== undefined
                    ? widget.content.computePercentages
                    : false,
            showTotal: widget.content.showTotal !== undefined ? widget.content.showTotal : true,
