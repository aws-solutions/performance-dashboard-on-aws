...
describe("donutChart", () => {
    ...
    it("return default ChartData on null data", () => {
        let result = ChartDataFormatter.donutChart(parts, exclude, null as unknown as Array<object>);
    ...
    it("handles exclude being null", () => {
        let result = ChartDataFormatter.donutChart(parts, null as unknown as Array<string>, sampleData);
...
describe("pieChart", () => {
    ...
    it("return default ChartData on null data", () => {
        let result = ChartDataFormatter.pieChart(parts, exclude, null as unknown as Array<object>);
    ...
    it("handles exclude being null", () => {
        let result = ChartDataFormatter.pieChart(parts, null as unknown as Array<string>, sampleData);
