...
function DataTable({ rows, columns, columnsMetadata, fileName, showMobilePreview, title }: Props) {
            ...
            columns.map((header) => {
                return {
                    ...
                    Cell: (props: any) => {
                        ...
                        let columnMetadata;
                        if (columnsMetadata) {
                            columnMetadata = columnsMetadata.find((cm) => cm.columnName === header);
                        }
    ...
    return (
        <>
            <div className={showMobilePreview ? "margin-left-05" : "text-right margin-right-05"}>
                <DropdownMenu
                    className="text-base"
                ...
                >
                    <MenuItem
                        ...
                        aria-label={
                            !showDataTable ? t("ShowDataTableButton") : t("HideDataTableButton")
                        }
                    >
                        <FontAwesomeIcon
                    ...
                    <MenuItem
                        onSelect={() => {
                            const downloadButton: HTMLAnchorElement | null = document.querySelector(
                    ...
                    >
                        <FontAwesomeIcon icon={faDownload} className="margin-right-1" size="xs" />
                        <CSVLink
                            data={tableRows}
